    ...
    <nav id="navbar" class="fixed top-8 left-0 right-0 z-40 transition-all duration-300">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex space-x-8">
                    ...
                    <a href="{{ route('a-propos') }}" class="nav-link hover:text-yellow transition-colors duration-300">À propos</a>
        ...
        <div id="mobile-menu" class="hidden md:hidden">
            <div class="px-2 pt-2 pb-3 space-y-1 bg-white shadow-lg">
                ...
                <a href="{{ route('a-propos') }}" class="mobile-nav-link block px-3 py-2 rounded-md text-olive hover:bg-yellow hover:text-olive transition-colors duration-300">À propos</a>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <div class="flex space-x-4">
                        <a href="https://www.facebook.com/Cactus972/?locale=fr_FR" target="_blank" rel="noopener noreferrer" class="hover:text-yellow">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                        </a>
                        <a href="https://www.instagram.com/echinofo/" target="_blank" rel="noopener noreferrer" class="hover:text-yellow">
